                ...
                case'validerPret': {
                        ...
                        if ((isset($_POST['cbxClients']) and ! empty($_POST['cbxClients'])) and ( isset($_POST['cbxOuvrages']) and ! empty($_POST['cbxOuvrages'])) and ( isset($_POST['dateEmp']) and ! empty($_POST['dateEmp']))) {
                            ...
                            if (Utilities::operationDate(($_POST['dateEmp']), date('Y-m-d'), "-") < 0) {
                                Application::addNotification(new Notification("La date d'emprunt doit être superieure ou égale au " . date('d/m/Y'), WARNING));
                                $erreur = true;
                            }
                            ...
                            if ($erreur == false) {
                                ...
                                $reponseProcedure = "L'ajout s'est terminé en retournant l'erreur suivante : ";
                                switch ($result) {
                                    case 0: {
                                    ...
                                    case -1: {
                                            ...
                                            Application::addNotification(new Notification($reponseProcedure . "aucun numéro de client n'a été transmis à la procédure", ERROR));
                                        }break;
                                    case -2: {
                                            // Erreurs anormale du à l'utilisateur //
                                    ...
                                    case -4: {
                                            // Erreurs anormale du à l'utilisateur //
                                            Application::addNotification(new Notification($reponseProcedure . "aucun numéro d'ouvrage n'a été transmis à la procédure", ERROR));
                                        }break;
                                    case -6: {
                                            // Erreurs anormale du à l'utilisateur //
                                    ...
                                    case -8: {
                                            // Erreurs anormale du à l'utilisateur //
                                            Application::addNotification(new Notification($reponseProcedure . "aucune date d'emprunt n'a été transmise à la procédure", ERROR));
                                        }break;
                                    case -10: {
